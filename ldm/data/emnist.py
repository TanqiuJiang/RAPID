...
class EMNISTTrain(EMNISTBase):
    def __init__(self, **kwargs):
        super().__init__(datadir="EMNIST_Train",split='digits', train=True, download=True, **kwargs)


class EMNISTVal(EMNISTBase):
    def __init__(self, **kwargs):
        super().__init__(datadir="EMNIST_Val",split='digits', train=False, download=True, **kwargs)
